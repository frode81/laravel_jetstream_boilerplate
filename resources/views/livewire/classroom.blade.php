...
<tr> <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $row->name}}</td>
 ...
 <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $row->classid}}</td>

 <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $row->owner}}</td>

 <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $row->courses}}</td>
...
<div><label class='block'><span class='text-gray-700 @error('classid') text-red-500  @enderror'>Classid</span><input type='text' class='mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('classid')  border-red-500 @enderror focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50' wire:model='classid'>@error('classid')<span class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label></div>
<div><label class='block'><span class='text-gray-700 @error('owner') text-red-500  @enderror'>Owner</span><input type='text' class='mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('owner')  border-red-500 @enderror focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50' wire:model='owner'>@error('owner')<span class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label></div>

<div><label class='block'><span class='text-gray-700 @error('category') text-red-500  @enderror'>Courses</span>

  <h1>Valgt : {{$courses_choosed = implode(' , ', (array)$courses);}}</h1>

  <select class="mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('category')  border-red-500 @enderror focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" wire:model='courses' multiple>
      <option disabled>Choose Courses</option>
      @foreach($Courses as $course)
          <option value="{{ $course->id }}">{{ $course->name }}</option>
      @endforeach
  </select>
  @error('course')<span class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label></div>


<!--<div><label class='block'><span class='text-gray-700 @error('courses') text-red-500  @enderror'>Courses</span><input type='text' class='mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('courses')  border-red-500 @enderror focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50' wire:model='courses'>@error('courses')<span class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label></div>-->

<h1>Valgt : {{$category;}}</h1>
<div><label class='block'><span class='text-gray-700 @error('category') text-red-500  @enderror'>Category</span><input type='text' class='mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('category')  border-red-500 @enderror focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50' wire:model='category'>@error('category')<span class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label></div>
